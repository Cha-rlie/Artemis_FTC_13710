...
import org.firstinspires.ftc.teamcode.RoadRunnerStoof.util.Encoder;
...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.013356; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 5.314; // in; offset of the lateral wheel

    private Encoder leftEncoder, rightEncoder, rearEncoder;

    public static double X_MULTIPLIER = 1.19445804558995; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.18992455979444; // Multiplier in the Y direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        rearEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "FrontLeft"));
